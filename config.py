...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002181981449"))

# Get this value from @BRANDRD_ROBOT on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", "7019160286"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/MP-BOTS-yt/Khamoshi",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Indians_Gossping")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Indians_Gossping")
